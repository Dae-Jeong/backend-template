...
def test_explicit_mapping_and_unregistered_error_fallback(
    ...
    caplog.set_level(logging.INFO, logger="template_api.http.observation")
    with TestClient(
